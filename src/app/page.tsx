  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground">
      <div className="flex-1">
        <header className="sticky top-0 z-10 bg-background text-foreground border-b border-border px-4 py-3">
        ...
        <main className="max-w-3xl mx-auto px-4 py-6 space-y-6">
          <Card>
            <CardHeader className="flex flex-row items-start space-x-4 pb-3">
              ...
              <div className="flex-1">
                ...
                <CardDescription>
                  Product Designer • 2 hours ago
                </CardDescription>
              </div>
            </CardHeader>
            <CardContent>
              <p>
                I am excited to announce that I have joined{" "}
                <span className="font-medium">Acme Inc</span> as a Senior
                Product Designer! Looking forward to creating amazing user
                experiences with this talented team.
              </p>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      May 2023 - Present • San Francisco, CA
                    </p>
                  </div>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <p>
                Just completed the AWS Solutions Architect certification!
                Excited to apply these cloud architecture skills to my projects.
              </p>
              <div className="mt-4 bg-card p-4 rounded-lg border border-border">
                <div className="flex items-center">
          ...
          <Card>
            <CardHeader className="flex flex-row items-start space-x-4 pb-3">
              ...
              <div className="flex-1">
                ...
                <CardDescription>
                  Frontend Developer • 3 days ago
                </CardDescription>
              </div>
            </CardHeader>
            <CardContent>
              <p>
                Thrilled to share that our team just launched the redesigned
                company website! Check it out at
              ...
              <div className="mt-4 bg-card rounded-lg border border-border overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    A complete overhaul of our digital presence with improved UX
                    and performance
                  </p>
                </div>
              </div>
